...
exports.updateTodo = exports.destroyTodo = exports.createTodo = exports.fetchTodos = exports.removeTodo = exports.receiveTodo = exports.receiveTodos = exports.REMOVE_TODO = exports.RECEIVE_TODO = exports.RECEIVE_TODOS = undefined;

var _todo_api_util = __webpack_require__(176);

var TodoAPIUtil = _interopRequireWildcard(_todo_api_util);

var _error_actions = __webpack_require__(178);
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return TodoAPIUtil.createTodo(todo).then(function (t) {
...
var destroyTodo = exports.destroyTodo = function destroyTodo(todo) {
  return function (dispatch) {
    return TodoAPIUtil.destroyTodo(todo).then(function (t) {
...
var updateTodo = exports.updateTodo = function updateTodo(todo) {
  return function (dispatch) {
    return TodoAPIUtil.updateTodo(todo).then(function (t) {
      dispatch(receiveTodo(t));
      dispatch((0, _error_actions.clearErrors)());
    }, function (err) {
      return dispatch((0, _error_actions.receiveErrors)(err.responseJSON));
...
var _errors_reducer = __webpack_require__(180);
...
var _root_reducers = __webpack_require__(40);
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(30),B=__webpack_require__(6),C=__webpack_require__(2),ba=__webpack_require__(31),da=__webpack_require__(32),ea=__webpack_require__(33),fa=__webpack_require__(34),ia=__webpack_require__(35),D=__webpack_require__(9);
...
var configureStore = function configureStore() {
  return (0, _redux.createStore)(_root_reducers2.default, (0, _redux.applyMiddleware)(_thunk.thunk));
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(22), __webpack_require__(11)(module)))
...
var _todo_list_container = __webpack_require__(158);
...
var _todo_list = __webpack_require__(159);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    destroyTodo: function destroyTodo(todo) {
      return dispatch(TodoActions.destroyTodo(todo));
    },
...
var _todo_list_item = __webpack_require__(160);

var _todo_list_item2 = _interopRequireDefault(_todo_list_item);

var _todo_form = __webpack_require__(161);
...
var TodoListItem = function (_React$Component) {
  ...
  _createClass(TodoListItem, [{
    ...
    value: function handleDelete(event) {
      event.preventDefault();
      var todo = (0, _merge2.default)({}, this.state, { id: event.target.id });
    ...
    value: function toggleTodo(event) {
      event.preventDefault();
      var todo = (0, _merge2.default)({}, this.state, { id: event.target.id, done: !this.props.listItem.done });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.handleDelete, id: listItem.id },
          'Delete Todo'
        ),
        _react2.default.createElement(
          'button',
          { onClick: this.toggleTodo, id: listItem.id },
          buttonTxt
        )
      );
    }
...
var TodoForm = function (_React$Component) {
  ...
  function TodoForm(props) {
    ...
    _this.handleTitleInput = _this.handleTitleInput.bind(_this);
    _this.handleBodyInput = _this.handleBodyInput.bind(_this);
    return _this;
  }
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleSubmit(event) {
      ...
      event.preventDefault();
      var todo = (0, _merge2.default)({}, this.state, { id: (0, _util2.default)() });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', onChange: this.handleTitleInput, value: this.state.title }),
          ...
          _react2.default.createElement('textarea', { onChange: this.handleBodyInput, value: this.state.body }),
