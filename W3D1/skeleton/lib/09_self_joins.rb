...
def craiglockhart_to_sighthill
  ...
  execute(<<-SQL)
    SELECT DISTINCT
      routes_from_craiglockhart.num,
      routes_from_craiglockhart.company,
      routes_from_craiglockhart.name,
      routes_to_sighthill.num,
      routes_to_sighthill.company
    FROM
    (
      SELECT DISTINCT
        a.num,
    ...
    ) AS routes_to_sighthill ON routes_from_craiglockhart.name = routes_to_sighthill.name
  SQL
end
